...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Spurious L4 subheading 'クレジットカード分析API' inserted under t14; ko has no such child — k14 is the single section heading with no repeated-title subheading beneath it) -->
