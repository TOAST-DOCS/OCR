...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (クレジットカードAPI is an invented L3 wrapper section with no Korean counterpart; the Korean source places 신용카드 분석 API (k14) directly at L3 with no parent grouping heading above it) -->
