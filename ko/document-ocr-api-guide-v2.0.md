...
## AI Service > OCR > Document OCR > API v2.0 가이드 { #ai-service-ocr-document-ocr-api-v20-guide }
...
- IV(초기화 벡터)는 대칭 키의 처음 16바이트(즉, 0~15번째 바이트)를 사용합니다.
- 암호 일련번호는 운전면허증 분석 결과에서 확인할 수 있습니다. 분석 결과에 암호 일련번호가 없으면 이용자에게 직접 입력받아 요청에 포함할 수 있습니다.
